...
def train_knn_model(X_train, y_train, model_path, label_encoder_path):
    # Encode labels
    le = LabelEncoder()
...
def main():
    ...
    train_knn_model(X_train_mfcc, y_train_mfcc, '/content/drive/MyDrive/archive/knn_model_mfcc.pkl', '/content/drive/MyDrive/archive/label_encoder_mfcc.pkl')
    ...
    train_knn_model(X_train_log_mel, y_train_log_mel, '/content/drive/MyDrive/archive/knn_model_log_mel.pkl', '/content/drive/MyDrive/archive/label_encoder_log_mel.pkl')
    ...
    train_knn_model(X_train_waveform, y_train_waveform, '/content/drive/MyDrive/archive/knn_model_waveform.pkl', '/content/drive/MyDrive/archive/label_encoder_waveform.pkl')
