...
Original file is located at
    https://colab.research.google.com/drive/1_lbfPvDqqVBq27XGy8O0yLTEZYKWL6LB
"""
...
def main():
    ...
    np.save('/content/drive/MyDrive/archive/X_train.npy', X_train)
    np.save('/content/drive/MyDrive/archive/X_test.npy', X_test)
    np.save('/content/drive/MyDrive/archive/y_train.npy', y_train)
    np.save('/content/drive/MyDrive/archive/y_test.npy', y_test)
