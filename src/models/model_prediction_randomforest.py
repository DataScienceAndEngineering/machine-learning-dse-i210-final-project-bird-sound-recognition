# -*- coding: utf-8 -*-
"""model_prediction_Randomforest.ipynb
...
def evaluate_rf_model(model_path, label_encoder_path, X_test, y_test):
...
def main():
    ...
    accuracy_mfcc, report_mfcc = evaluate_rf_model('/content/drive/MyDrive/archive/rf_model_mfcc.pkl', '/content/drive/MyDrive/archive/label_encoder_mfcc.pkl', X_test_mfcc, y_test_mfcc)
    ...
    accuracy_log_mel, report_log_mel = evaluate_rf_model('/content/drive/MyDrive/archive/rf_model_log_mel.pkl', '/content/drive/MyDrive/archive/label_encoder_log_mel.pkl', X_test_log_mel, y_test_log_mel)
    ...
    accuracy_waveform, report_waveform = evaluate_rf_model('/content/drive/MyDrive/archive/rf_model_waveform.pkl', '/content/drive/MyDrive/archive/label_encoder_waveform.pkl', X_test_waveform, y_test_waveform)
